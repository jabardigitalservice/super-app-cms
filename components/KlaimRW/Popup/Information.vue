  ...
  >
    <div class="py-[16px] font-lato text-gray-800">
      <div class="flex justify-start items-start">
        <jds-icon name="check-mark-circle" class="w-[16px] h-[16px] mt-1" fill="#069550" />
        <div class="ml-[13px]">
      ...
      <div class="bg-blue-50 border border-blue-500 h-fit w-full py-[8px] pr-[12px] pl-[14px] rounded-lg mt-[24px]">
        <div class="flex">
