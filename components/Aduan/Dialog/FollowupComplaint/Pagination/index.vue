<template>
  <div class="flex w-full items-center justify-between pl-2 form-followup-pagination">
    <p>
    ...
    <div class="flex">
      <div>
        ...
        <jds-select :options="listOptions" :value="pagination.currentPage" @change="pageChanges" />
...
.form-followup-pagination .jds-select .jds-input-text__input-wrapper {
  @apply !h-[44px] !w-16 !rounded-none !border !border-none !bg-white;
}
</style>
