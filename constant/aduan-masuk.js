...
export const complaintDivertedToSpanHeader = [
  ...complaintHeader
]
complaintDivertedToSpanHeader.splice(4, 1, { key: 'sp4n_created_at', text: 'Tanggal Diinput SP4N', sortable: true },
...
export const typeAduan = {
  ...
  aduanDariSpanLapor: { props: 'aduan-dari-soab-lapor', label: 'Daftar Aduan dari SP4N Lapor', link: '/aduan/aduan-dari-span-lapor', id: 'aduanDariSpanLapor' }
}
